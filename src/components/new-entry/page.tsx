...
export default function NewArticle(props: { type: string }) {
  // TODO type은 post, question 두가지로 넘어옴. 해당 값에 따라서 DB저장 하면 된다.
  return (
    <div className="h-full flex-col md:flex">
      <div className="container flex flex-col items-start justify-between space-y-2 py-4 sm:flex-row sm:items-center sm:space-y-0 md:h-16">
        <h2 className="text-lg font-semibold">Playground {props.type}</h2>
